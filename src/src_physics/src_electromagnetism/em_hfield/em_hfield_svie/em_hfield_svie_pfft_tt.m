function[h_field] = em_hfield_svie_pfft_tt(MREDM,gpu_flag)
    ...
    for i = 1:2
        ...
        for port = 1:A_ports
            ...
            H_vox_inc                 = pfft_Z_bc_K * Jc(:,port) +  pfft_PS(:,N_sie+1:end).' * H_vox_inc(:);
            H_vox_sca                 = pfft_PS(:,N_sie+1:end).' * H_vox_sca(:);
