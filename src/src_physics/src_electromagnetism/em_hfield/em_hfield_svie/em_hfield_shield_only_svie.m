function[h_field] = em_hfield_shield_only_svie(MREDM,gpu_flag)
    ...
    max_rank_K_shield_sie = dims.max_rank_K_shield_sie;
    ...
    for i = 1:2
        ...
        % Total Field
        for port = 1:A_ports
            tested_hinc           = func.mvp_Zbc(MREDM.operators.Zbs_K,Js(:,port),n1,n2,n3,N_shield_sie,max_rank_K_shield_sie);         
