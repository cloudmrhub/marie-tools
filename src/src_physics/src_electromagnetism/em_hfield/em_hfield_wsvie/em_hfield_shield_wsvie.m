function[h_field] = em_hfield_shield_wsvie(MREDM,gpu_flag)
    ...
    for i = 1:2
        ...
        % Total Field
        for port = 1:A_ports
            tested_hinc_wire      = func.mvp_Zbw(MREDM.operators.Zbw_K,Jw(:,port),n1,n2,n3,N_wie,max_rank_wie); 
            ...
            tested_hinc           = tested_hinc_wire+tested_hinc_coil+tested_hinc_shield;
