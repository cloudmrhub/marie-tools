function[h_field] = em_hfield_shield_wvie(MREDM,gpu_flag)
    ...
    for i = 1:2
        if ~isempty(MREDM.fields.JcbTx) && i == 1
            ...
            Jw      = MREDM.fields.JcbTx(N_shield_sie+1:N_coil,:);
        ...
        elseif ~isempty(MREDM.fields.JcbRx) && i == 2      
            ...
            Jw      = MREDM.fields.JcbRx(N_shield_sie+1:N_coil,:);
        ...
        for port = 1:A_ports
            ...
            tested_hinc           = tested_hinc_wire+tested_hinc_shield;
