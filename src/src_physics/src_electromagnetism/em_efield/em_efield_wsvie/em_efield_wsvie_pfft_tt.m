function[e_field] = em_efield_wsvie_pfft_tt(MREDM,gpu_flag)
    ...
    for i = 1:2
        ...
        for port = 1:A_ports
            ...
            E_vox_inc                 = pfft_Z_bc_N * Jc(:,port) + pfft_PS(:,N_coil+1:end).' * E_vox_inc(:);
            E_vox_sca                 = pfft_PS(:,N_coil+1:end).' * E_vox_sca(:);
