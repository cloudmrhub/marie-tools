function[e_field] = em_efield_shield_wsvie(MREDM,gpu_flag)
    ...
    N_coil              = N_shield_sie + N_wie + N_sie;
    n1                  = dims.n1;
    n2                  = dims.n2;
    n3                  = dims.n3;
    ql                  = dims.ql;
    ...
    for i = 1:2
        if ~isempty(MREDM.fields.JcbTx) && i == 1
            ...
            Jw      = MREDM.fields.JcbTx(N_shield_sie+1:N_shield_sie+N_wie,:);
            Jc      = MREDM.fields.JcbTx(N_shield_sie+N_wie+1:N_coil,:);
        ...
        elseif ~isempty(MREDM.fields.JcbRx) && i == 2        
            ...
            Jw      = MREDM.fields.JcbRx(N_shield_sie+1:N_shield_sie+N_wie,:);
            Jc      = MREDM.fields.JcbRx(N_shield_sie+N_wie+1:N_coil,:);
        ...
        for port = 1:A_ports
            tested_einc_wire      = func.mvp_Zbw(MREDM.operators.Zbw_N,Jw(:,port),n1,n2,n3,N_wie,max_rank_wie); 
            tested_einc_coil      = func.mvp_Zbc(MREDM.operators.Zbc_N,Jc(:,port),n1,n2,n3,N_sie,max_rank_sie); 
            tested_einc_shield    = func.mvp_Zbc(MREDM.operators.Zbs_N,Js(:,port),n1,n2,n3,N_sie,max_rank_shield_sie); 
            tested_einc           = tested_einc_wire+tested_einc_coil+tested_einc_shield;
