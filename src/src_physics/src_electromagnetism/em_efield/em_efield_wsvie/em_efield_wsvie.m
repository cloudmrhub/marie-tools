function[e_field] = em_efield_wsvie(MREDM,gpu_flag)
    ...
    for i = 1:2
        if ~isempty(MREDM.fields.JcbTx) && i == 1
            ...
            Jc      = MREDM.fields.JcbTx(N_wie+1:N_coil,:);
        ...
        elseif ~isempty(MREDM.fields.JcbRx) && i == 2        
            ...
            Jc      = MREDM.fields.JcbRx(N_wie+1:N_coil,:);
        ...
        for port = 1:A_ports
            ...
            tested_einc           = tested_einc_wire+tested_einc_coil;
