function [M_cal,...
          ...
          SPm,...
          SP_check,...
          phi_lumped_elements] = calibration_tune_match_TxRx_decouple_and_TxRx_preampdecouple(X,...
                                                                                              YPn,...
                                                                                              symmetries,...
                                                                                              match_split,...
                                                                                              mask_detailed_split,...
    ...
    ZPn_Rx = inv(YPm_Rx);
    YPm_Tx = YPm;
    YPm_Tx(RxM_det,RxM_det) = YPm_Rx(RxM_det,RxM_det)+Rxdet;
    ZPn_Tx = inv(YPm_Tx);
    ...
    YPm_Tx_loss = YPm_loss(TxM,TxM)-YPm_loss(TxM,RxM_det)/(YPm_loss(RxM_det,RxM_det)+Rxdet)*YPm_loss(RxM_det,TxM);
