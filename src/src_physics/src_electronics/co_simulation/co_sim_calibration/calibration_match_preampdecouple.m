function [M_cal,YPm,ZPm,SPm,SP_check] = calibration_match_preampdecouple(matching_elements,YPm,matching_load_string,port_order,omega,z0,preamp_res)
    ...
    for k = 1:P
        ...
        M_match(k,k) = calibration_matching(SPs,SPm,z0);
        SP_check(k,1) = SPm;
    end
