function [M_cal,YPm_Tx,ZPm,SPm,SP_check] = calibration_match_TxRx_decouple_and_TxRx_preampdecouple(matching_elements,...
                                                                                               YPm,...
                                                                                               match_split,...
                                                                                               mask_detailed_split,...
    ...
    RxM                              = match_split==1;
    TxM                              = match_split==2;
    RxM_det                          = match_split==1 | match_split==3;
    TxM_det                          = match_split==2 | match_split==3;
    ...
    YPm_Rx = YPm(RxM_det,RxM_det)-YPm(RxM_det,TxM)/(YPm(TxM,TxM)+Txdet)*YPm(TxM,RxM_det);
    YPm_Tx = YPm(TxM_det,TxM_det)-YPm(TxM_det,RxM)/(YPm(RxM,RxM)+Rxdet)*YPm(RxM,TxM_det);
