function [M_cal,...
          ...
          SPm,...
          SP_check,...
          phi_lumped_elements] = calibration_tune_match_Tx_decouple_and_Rx_preampdecouple(X,...
                                                                                          YPn,...
                                                                                          symmetries,...
                                                                                          match_split,...
                                                                                          mask_detailed_split,...
    ...
    % Add tuning elements to loss
    YPm_Rx_loss = YPm_loss(RxM,RxM)-YPm_loss(RxM,TxM)/(YPm_loss(TxM,TxM)+Txdet)*YPm_loss(TxM,RxM);
    YPm_Tx_loss = YPm_loss(TxM,TxM)-YPm_loss(TxM,RxM)/(YPm_loss(RxM,RxM)+Rxdet)*YPm_loss(RxM,TxM);
