function [M_cal,...
    ...
    YPm_loss_Rx = YPm_loss(RxM,RxM)-YPm_loss(RxM,TxM)/(YPm_loss(TxM,TxM)+Txdet)*YPm_loss(TxM,RxM);
    YPm_loss_Tx = YPm_loss(TxM,TxM)-YPm_loss(TxM,RxM)/(YPm_loss(RxM,RxM)+Rxdet)*YPm_loss(RxM,TxM);
    ...
    M_cal.rx = ((M_tune*M_detune_Rx)*M_decouple_Rx)*M_match_Rx;
