function[return_elements,M_cal,YPm,ZPm,SPm,SP_check,figure_freq] = co_simulation_TxRx_and_Rx_optim(YPn,emc,RLC_org,RLC_tmd,options_PSO_1,options_PSO_2)
    ...
    [M_cal,...
     YPm,...
     ZPm,...
     SPm,SP_check] = calibration_tune_match_TxRx_decouple_and_Rx_preampdecouple(elements_after_optimization,...
                                                                                YPn,...
                                                                                symmetries_all,...
                                                                                match_split,...
                                                                                mask_detailed_split,...
