function[return_elements,phi_lumped_elements,M_cal,YPm,ZPm,SPm,SP_check,figure_freq] = co_simulation_TxRx_optim(YPn,emc,RLC_org,RLC_tmd,Q_val,options_PSO_1,options_PSO_2)
    ...
    % Tuning and Matching and Decoupling and Preamplifier Decoupling
    [elements_after_tuning_matching_decoupling,...
     ...
     all_tuning_mask,...
     all_mutual_mask,...
     symmetries_all] = runner_M_T_D_PD(matching_load_string,...
                                       tuning_load_string,...
                                       port_order,...
                                       symmetries_all,...
                                       matching_mask_detailed,...
    ...
    [M_cal,...
     ...
     SPm,...
     SP_check,...
     phi_lumped_elements] = calibration_tune_match_decouple_and_preampdecouple(elements_after_tuning_matching_decoupling,...
                                                                               YPn,...
                                                                               symmetries_all,...
                                                                               all_matching_mask_detailed,...
                                                                               all_fixed_matching_mask_detailed,...
    ...
    % Validate
    figure_freq = get_ZPm_TxRx_freq(elements_after_tuning_matching_decoupling,...
                                    YPn,...
                                    symmetries_all,...
                                    all_matching_mask_detailed,...
                                    all_fixed_matching_mask_detailed,...
