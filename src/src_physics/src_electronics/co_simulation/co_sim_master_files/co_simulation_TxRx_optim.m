function[return_elements,M_cal,YPm,ZPm,SPm,SP_check,figure_freq] = co_simulation_TxRx_optim(YPn,emc,RLC_org,RLC_tmd,options_PSO_1,options_PSO_2)
    ...
    [M_cal,...
     YPm,...
     ZPm,...
     SPm,SP_check] = calibration_tune_match_decouple_and_preampdecouple(elements_after_tuning_matching_decoupling,...
                                                                        YPn,...
                                                                        symmetries_all,...
                                                                        all_matching_mask_detailed,...
                                                                        all_fixed_matching_mask_detailed,...
