function[return_elements,phi_lumped_elements,M_cal,YPm,ZPm,SPm,SP_check,figure_freq] = co_simulation_Tx_optim(YPn,emc,RLC_org,RLC_tmd,Q_val,options_PSO_1,options_PSO_2)
    ...
    [M_cal,...
     ...
     ZPm,...
     SPm,...
     phi_lumped_elements] = calibration_tune_match_decouple(elements_after_tuning_matching_decoupling,...
                                                            YPn,...
                                                            symmetries_all,...
                                                            all_fixed_matching_mask_detailed,...
                                                            all_fixed_matching_values,...
