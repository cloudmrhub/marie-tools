function[Jcb] = ie_solver_shield_only_svie(MREDM,gpu_flag)
    ...
    mvp      = @(J)mvp_svie(J, Zbs, Zss, MREDM.EP.Mcr_inv, func, N, emc, max_rank_shield_sie, N_shield_sie, res, n1, n2, n3, ql, idx_solution);
    for i = 1:A_ports
        tic
