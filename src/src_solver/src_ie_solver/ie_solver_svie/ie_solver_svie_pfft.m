function[Jcb] = ie_solver_svie_pfft(MREDM,gpu_flag)
    ...
    mvp          = @(J)mvp_svie_pfft(J, pfft_PS, pfft_Z_cc, pfft_Z_bc_N, MREDM.EP.ext_Mc_inv, func, N, Multiplier_1, Multiplier_2, emc, N_sie, res, pfft_dims);
    for i = 1:A_ports
        tic
