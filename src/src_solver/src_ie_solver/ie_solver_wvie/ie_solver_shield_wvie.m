function[Jcb] = ie_solver_shield_wvie(MREDM,gpu_flag)
    ...
    mvp     = @(J)mvp_shield_svie(J, ZswU, ZswV, Zbs, Zbw, Zss, Zww, MREDM.EP.Mcr_inv, func, N, emc, max_rank_shield_sie, max_rank_wie, N_shield_sie, N_wie, res, n1, n2, n3, ql, idx_solution);
    for i = 1:A_ports
        tic
