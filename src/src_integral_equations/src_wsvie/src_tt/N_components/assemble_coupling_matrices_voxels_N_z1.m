function[Zbc_N] = assemble_coupling_matrices_voxels_N_z1(SIE_quads,VIE_quads,k0,n1,n2,n3,xd,yd,zd,res,rp,rn,r2,r3,ttnS)
    ...
    for i = 1:length(ttn4)
        Zbc_Nt{i} = Assemble_rwg_coupling_matrix_N_z1(Scoord{i}.',rpt(:,i),rnt(:,i),r2t(:,i),r3t(:,i),SIE_quads,VIE_quads,res,k0);
    end
