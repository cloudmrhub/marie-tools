...
parfor index_VA = 1 : n_VA_elem
    ...
    [I_DE] = direct_ws_va_rwg(ro(:,orderp(1)) , ro(:,orderp(2)) , ro(:,orderp(3)) , rs(:,orderq(2)) , rs(:,orderq(3)) , ko, N_theta_p, N_theta_q, N_psi, w_theta_p, z_theta_p, w_theta_q, z_theta_q, w_psi, z_psi);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
