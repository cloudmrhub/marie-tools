...
while ~(feof(fid)) % it is not the end of the file, keep reading
        ...
        if strcmp(line, '$Nodes') % start the nodes
            ...
            %IMPORTANT: in gmsh the node-number (first integer) is a postive (non-zero) integer,
            ...
            for ii = 1:nelem % read all nodes
                ...
                switch eltype
                    ...
                    case 1 % edge
                        ...
                        lines(3,ecount) = vec(4); % physical line
                    ...
                    case 2 % triangle
                        ...
                        triang(4,tcount) = vec(4); % physical surface
                    ...
                    case 3 % quadrangle
                        ...
                        quad(5,qcount) = vec(4); % physical surface
                    ...
                    case 15 % point
                        ...
                        singlep(5,pcount) = vec(4); % physical
