function [PS,MREDM] = pfft_projection_surface_assembly(MREDM)
    
    MREDM = pfft_proj_surface_create_near_lists(MREDM);
    coil  = MREDM.SIE.coil;
    k0    = MREDM.emc.k0;
    ce    = MREDM.emc.ce;
    ...
    for i_sie = 1:N_sie
        ...
        ctr_vox_idx     = central_cell_id(:, i_sie);
        cel_vox_idx     = cell_id(:, i_sie);
